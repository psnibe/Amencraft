...
fun void rollOut()
{
    ...
    spork ~ playAmen(1, 0.75, rate[ratedex], (tempoMod[ratedex]*(bar/2))) @=> mainShreds[1];
    spork ~ playAmen(2, 0.50, rate[ratedex], (tempoMod[ratedex]*beat)) @=> mainShreds[2];
    spork ~ playAmen(3, 0.25, rate[ratedex], (tempoMod[ratedex]*(beat/2))) @=> mainShreds[3];    
