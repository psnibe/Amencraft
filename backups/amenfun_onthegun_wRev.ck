...
fun void rollOut()
{
    ...
    spork ~ playAmen(1, 0.75, rate, (tempoMod*(bar/2))) @=> mainShreds[1];
    spork ~ playAmen(2, 0.50, rate, (tempoMod*beat)) @=> mainShreds[2];
    spork ~ playAmen(3, 0.25, rate, (tempoMod*(beat/2))) @=> mainShreds[3];    
