...
fun void rollOut()
{
    spork ~ playAmen(1.0, rate, (tempoMod*bar)) @=> mainShreds[0];
    spork ~ playAmen(0.75, rate, (tempoMod*(bar/2))) @=> mainShreds[1];
    spork ~ playAmen(0.50, rate, (tempoMod*beat)) @=> mainShreds[2];
    spork ~ playAmen(0.25, rate, (tempoMod*(beat/2))) @=> mainShreds[3];    
